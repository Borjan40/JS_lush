...
let callBack1 = elem => Math.pow(elem, 2);

// let lopos = ar1.forEach(item => console.log(Math.pow(item, 2)))
// console.log(lopos);
...
let res5 = [];
let callBack5 = elem => elem.toLowerCase();
res5 = ar5.map(callBack5)
console.log(res5);
...
function getUserName(fixFunc) {
    const userName = document.querySelector('.i-6').value;
