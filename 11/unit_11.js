...
function f4() {
    let temp = document.querySelector('.i-4')
    d1.push(temp.value)
...
function f5() {
    let temp = document.querySelector('.i-5')
    d1.unshift(temp.value)
    showArr('.out-5', d1);
}
...
function f6() {
    let temp = document.querySelector('.i-6')
    d6[d6.length] = temp.value
    showArr('.out-6', d6);
}
...
function f8() {
    let temp = document.querySelector('.i-8')
    let newArr = []
    newArr[0] = temp.value
    console.log(temp.value)
    for (i = 0; i < d8.length; i++) {
        newArr[newArr.length] = d8[i]
        // newArr.push(d8[i]);
    }
    console.log(newArr)
    d8 = newArr
...
function f11() {
    ...
    let temp = +inp.value // + - преобразует в число    console.log(typeof temp)
    console.log(typeof d11[0])
    let out = d11.indexOf(temp)
    // if (out == -1) {
    //     d11.push(temp)
    // } -15 задача
    document.querySelector('.out-11').append(out)
    // document.querySelector('.out-11').innerHTML = d11 -15 задача
}
...
function f12() {
    let input11 = document.querySelector('.i-12');
    let valInp11 = +input11.value;
    console.log(valInp11)
...
function f18() {
    console.log(d18.includes(document.querySelector('.i-18').value))
}
...
function f20() {
    ...
    document.querySelector('.out-20').append(d20.join(''))
}
