...
function f6() {
    let InpVal61 = document.querySelector('.i-61');
    let InpVal62 = document.querySelector('.i-62');

    let temp = InpVal62.value
    a6[temp] = InpVal61.value

    // a6.newKey = InpVal61.value
    // let tempKey = newKey
    // tempKey = InpVal62.value


    // let newKeyVal = InpVal62.value
...
function f7(num) {
    // let inp10 = document.querySelector('.i-7');
    // let temp = (a7[inp10.value] != null) ? '1' : '0';
    // document.querySelector('.out-7').append(temp)

    let temp = (a7[num] != null) ? '1' : '0';
    document.querySelector('.out-7').append(temp)
...
function f8() {
    ...
    temp = (a8[inp.value] != null) ? a8[inp.value] : '0';
...
function f9() {
    ...
    // temp = (a9[val] != null) ? '1' : '0';
    let out = '';

    for (let key in a9) {

        out += (a9[key] == inp.value) ? key : ' _ ';
    }
...
function f10(arr, val) {
    // temp = null
    // let containTrue = undefined
    // let containFalse = undefined
    // for (let key in arr) {
    //     temp = (arr[key] == val);
    //     if (temp) {
    //         containTrue = temp
...
function f18() {
    ...
    for (i = 0; i < a18[inp.value].length; i++) {
        out += `${a18[inp.value][i]} `;
    }
...
function f19() {
    ...
    for (let key in a19) {
        for (i = 0; i < a19[key].length; i++) {
            ...
            if (a19[key][i].toLowerCase() == inp.value.toLowerCase()) {
    ...
    document.querySelector('.out-19').innerHTML = '_'
}
...
function f20() {
    ...
    //             if (a20[key][i][k] == 2 || a20[key][i][k] == 3) {
    //                 temp += `${a20[key][i][0]}<br>`
    //                 console.log(temp)
    //             }
    //         }
    //     }
    // }
    // document.querySelector('.out-20').innerHTML = temp
