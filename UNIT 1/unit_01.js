...
out1.innerHTML = getRandomFloat(117, 133)
...
function updateMinMax() {
    out2.innerHTML = getRandomFloat2(min, max)
}
updateMinMax()
console.log(min)
...
function t6() {
    ...
    let boolResult = (out2.textContent % 2 == 0) ? even() : odd();
...
function t7() {
    ...
    (z7 !== 100) ? out7.textContent = z7++ : null;
