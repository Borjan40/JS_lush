...
function f5() {
    ...
    out5.innerHTML = out4.classList.toggle('bg-4');
}
...
function f6() {
    ...
    let allParagr = document.querySelectorAll('.p-6')
    console.log(allParagr)
    let out = document.querySelector('.out-6');
    // console.log(allParagr.length);
    out.innerHTML = allParagr.length
}
...
function f7() {
    let allOut7 = document.getElementsByClassName('out-7');
    console.log(allOut7)
    for (let i = 0; i < allOut7.length; i++) {
        allOut7[i].classList.toggle('bg-7')
    }
}
...
function f8() {
    ...
    let allOut8 = document.getElementsByClassName('out-8')

    for (let i = 0; i < allOut8.length; i++) {
        allOut8[i].classList.toggle('bg-8')
    }
...
let div10 = document.getElementsByClassName('out-10')
...
function f12() {
    ...
    temp.innerHTML = textVal;
    temp.classList.add('bg-12');
    document.querySelector('.out-12').appendChild(temp)
}
...
function f13() {
    ...
    let textVal = 'pushMe'
    temp.innerHTML = textVal;
    temp.classList.add('bg-13');
    document.querySelector('.out-13').appendChild(temp)
    temp.onclick = f13_1
}
