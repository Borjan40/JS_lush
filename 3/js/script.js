...
function f1() {
    ...
    let result = num === 4            // === совместно с parseInt дают сравнение с приведением типов, в данном варианте тип число, если было записано '4' было бы false
    console.log(result);
...
function f3() {
    ...
    let num1 = parseInt(inp31.value);
    let num2 = parseInt(inp32.value);
...
function f7() {
    let num1 = parseInt(inp71.value);
    let num2 = parseInt(inp72.value);
    output7.innerHTML = Math.pow(num1, num2);
}
...
let inp8 = document.querySelector('.s-8');
let output8 = document.querySelector('.out-8');

function f8() {
    let num = parseInt(inp8.value);
    console.log(num);
...
let inp10 = document.querySelector('.s-100');
let output10 = document.querySelector('.out-10');

function f10() {
    let num = parseInt(inp10.value);
    console.log(num);
    output10.innerHTML = num;
}
...
let inp11 = document.querySelector('.s-110');
// let output11 = document.querySelector('.out-11');

function f11() {
    let num = parseInt(inp11.value);
    // output11.innerHTML = num;
...
let getBoolOperat = document.querySelector('.s-153');
let getBoolVal1 = document.querySelector('.s-151');
let getBoolVal2 = document.querySelector('.s-152');
let output15 = document.querySelector('.out-15');

function f15() {
    let operat = getBoolOperat.value;
    let val1 = parseInt(getBoolVal1.value);
    let val2 = parseInt(getBoolVal2.value);

    if (operat == '&&') {
        document.querySelector('.out-15').innerHTML = val1 && val2;
    } else {
        document.querySelector('.out-15').innerHTML = val1 || val2;
    }
}
