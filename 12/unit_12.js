...
function f1() {
    ...
    // ];
    // let string = [{ field }]
    // string[0].field[0][2].name = 'Vasya';
    // console.log(string[0].field[0][2])
...
function f2() {
    ...
    console.log(a2[0][1])
    document.querySelector('.out-2').append(a2[0][1])
}
...
function f3() {
    ...
    document.querySelector('.out-3').append(a3[2][1][1])
}
...
function f4() {
    ...
    console.log(a4[1])
    document.querySelector('.out-4').append(a4[1])
}
...
function f6() {
    let out = '';
    let a6 = [[1, 2], [3, 4], [5, 6], [21, 34], [44, 56, 69, 71]];
...
function f15() {
    ...
    let temp = a15[0].length
    for (let i = 0; i < a15.length; i++) {
        if (a15[i].length > temp) {
            temp = a15[i].length
        }
    }
    console.log(temp)
